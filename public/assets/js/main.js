...
},{"../../package.json":9,"./dashboard":3,"./directives":4,"./filters":5,"./services":6,"angular":8,"angular-route":7}],2:[function(require,module,exports){
/**
 * 
 */
;(function(){
...
},{"../../../package.json":9}],3:[function(require,module,exports){
;(function() {
	'use strict';
...
},{"./dashboardCtrl.js":2}],4:[function(require,module,exports){
;(function() {
	'use strict';
...
//	var x = require('x');
	...
	var rpappDirectives = angular.module('rpapp.directives', [
//			x.name
	    ]);

	module.exports = rpappDirectives;
}).call(this);
...
//	var x = require('x');
	...
	var rpappFilters = angular.module('rpapp.filters', [
//			x.name
	    ]);
	
	module.exports = rpappFilters;
}).call(this);
...
module.exports={
  ...
  "scripts": {
    "test": "test",
    "build": "npm run build-copy && npm run build-templates && npm run build-js",
    "build-copy": "rm -f -r public && mkdir public && cp -R client/assets client/vendor client/*.html public",
    "build-templates": "/bin/zsh -c 'cp client/*/**/*.html public/templates' 2>/dev/null || true",
    "build-js": "mkdir -p public/assets/js && browserify client/app/app.js > public/assets/js/main.js"
  },
  "repository": {
    "type": "git",
